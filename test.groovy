    ...
    agent any
       stages{  
           ...
           stage("rerun"){
               ...
               steps{
                   bat "python -m robot.run --rerunfailed reports/output_1.xml --output output_2.xml --log log_2.html --report report_2.html -d reports C:/Users/mp05/PycharmProjects/mohan/robot_test/test.robot"
